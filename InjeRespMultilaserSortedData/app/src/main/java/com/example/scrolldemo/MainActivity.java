                ...
                try {
                   ...
                   /* 1. Volume Tidal.
                    ...
                    if (lastX > 200) {
                        ...
                        lastX++;
                        /*data.concat("/n");
                        tvAppend(terminal, Integer.toString(p));
                        tvAppend(terminal, "  ");*/
                        if (p < 1000) {
                            //data.concat("/n");
                            tvAppend(terminal, "primeira: ");
                            tvAppend(terminal, Integer.toString(p));
                            tvAppend(terminal, "  ");
                        } else if (p < 2000) {
                            p = p - 1000;
                            data.concat("/n");
                            tvAppend(terminal, "segunda: ");
                            tvAppend(terminal, Integer.toString(p));
                            tvAppend(terminal, "  ");
                        } else if (p < 3000) {
                            p = p - 2000;
                            //data.concat("/n");
                            tvAppend(terminal, "terceira: ");
                            tvAppend(terminal,Integer.toString(p));
                            tvAppend(terminal, "  ");
                        } else if (p < 4000) {
                            p = p - 3000;
                            //data.concat("/n");
                            tvAppend(terminal, "quarta: ");
                            tvAppend(terminal, Integer.toString(p));
                            tvAppend(terminal, "  ");
                        } else if (p < 5000) {
                            p = p - 4000;
                            ...
                            p = p - 5000;
                            //data.concat("/n");
                            tvAppend(terminal, "quinta: ");
                            tvAppend(terminal, Integer.toString(p));
                            tvAppend(terminal, "  ");
                        } else if (p < 7000) {
                            p = p - 6000;
                            //data.concat("/n");
                            tvAppend(terminal, "sexta: ");
                            tvAppend(terminal, Integer.toString(p));
                            tvAppend(terminal, "  ");
                        } else if (p < 8000) {
                            p = p - 7000;
                            //data.concat("/n");
                            tvAppend(terminal, "setima: ");
                            tvAppend(terminal, Integer.toString(p));
                            tvAppend(terminal, "  ");
                        } else if (p < 9000) {
                            p = p - 8000;
                            //data.concat("/n");
                            tvAppend(terminal, "oitava: ");
                            tvAppend(terminal, Integer.toString(p));
                            tvAppend(terminal, "  ");
                        } else if (p < 10000) {
                            p = p - 9000;
                            //data.concat("/n");
                            tvAppend(terminal, "nona: ");
                            tvAppend(terminal, Integer.toString(p));
                            tvAppend(terminal, "  ");
                        } else if (p < 11000) {
                            p = p - 10000;
                            //data.concat("/n");
                            tvAppend(terminal, "decima: ");
                            tvAppend(terminal, Integer.toString(p));
                            tvAppend(terminal, "  ");
                        } else if (p < 12000) {
                            p = p - 11000;
                            //data.concat("/n");
                            tvAppend(terminal, "decima primeira: ");
                            tvAppend(terminal, Integer.toString(p));
                            tvAppend(terminal, "  ");
                        } else if (p < 13000) {
                            p = p - 12000;
                            //data.concat("/n");
                            tvAppend(terminal, "decima segunda: ");
                            tvAppend(terminal, Integer.toString(p));
                            tvAppend(terminal, "  ");
                        }
                    }
